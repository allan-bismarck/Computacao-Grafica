...
void DefineIluminacao (void)
{
	...
	glMaterialfv(GL_FRONT_AND_BACK,GL_DIFFUSE, cores[0]);
	...
	if (emite) {
		...
		glMaterialfv(GL_FRONT_AND_BACK,GL_EMISSION,cores[1]);
	}
	else {
		glMaterialfv(GL_FRONT_AND_BACK,GL_EMISSION,semCorEmissao);
	}
